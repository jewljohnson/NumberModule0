public class Module1 
{
	...
	public static void main(String[] args) 
	{
		...
		if( j < 20 ) // If the inputted integer is less than twenty a simple switch statement will be used
		{
			isLessThanTwenty(j);
		}
	}
	private static void isLessThanTwenty(int i)
	{
		//Pre: Receive input from user that is less 20
		...
		//Post: Prints the name of the integer the client typed.
		
		//---------------WARNING-------------------------\\
		//Extending this method to include numbers would be entirely to tedious
		/*
		 * Instead I will be writing this program to identify whole numbers via brute 
